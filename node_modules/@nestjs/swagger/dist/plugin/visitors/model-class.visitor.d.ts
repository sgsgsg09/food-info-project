...
export declare class ModelClassVisitor extends AbstractFileVisitor {
    ...
    visitPropertyNodeDeclaration(node: ts.PropertyDeclaration, ctx: ts.TransformationContext, typeChecker: ts.TypeChecker, options: PluginOptions, sourceFile: ts.SourceFile, metadata: ClassMetadata, externalImports: Record<string, string>): ts.PropertyDeclaration;
